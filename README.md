...
2. **[Data Preprocessing](https://github.com/ebeui/heart_disease_prediction/blob/main/eda_visualizations.ipynb)**: In this notebook, we will perform data cleaning, feature selection, and feature engineering to prepare the data for modeling. Our main goals here are to remove missing values, handle outliers, and transform the data into a suitable format for machine learning algorithms.
